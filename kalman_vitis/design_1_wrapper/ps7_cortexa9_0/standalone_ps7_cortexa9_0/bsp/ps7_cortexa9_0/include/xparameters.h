...
/* Definitions for driver KALMAN_FILTER_TOP */
#define XPAR_XKALMAN_FILTER_TOP_NUM_INSTANCES 1

/* Definitions for peripheral KALMAN_FILTER_TOP_0 */
#define XPAR_KALMAN_FILTER_TOP_0_DEVICE_ID 0
#define XPAR_KALMAN_FILTER_TOP_0_S_AXI_CONTROL_BUS_BASEADDR 0x40000000
#define XPAR_KALMAN_FILTER_TOP_0_S_AXI_CONTROL_BUS_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral KALMAN_FILTER_TOP_0 */
#define XPAR_XKALMAN_FILTER_TOP_0_DEVICE_ID XPAR_KALMAN_FILTER_TOP_0_DEVICE_ID
#define XPAR_XKALMAN_FILTER_TOP_0_S_AXI_CONTROL_BUS_BASEADDR 0x40000000
#define XPAR_XKALMAN_FILTER_TOP_0_S_AXI_CONTROL_BUS_HIGHADDR 0x4000FFFF
