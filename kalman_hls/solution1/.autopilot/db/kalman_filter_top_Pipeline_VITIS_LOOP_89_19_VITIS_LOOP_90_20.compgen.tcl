...
set name kalman_filter_top_mul_17ns_32s_48_2_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp_V \
    op interface \
    ports { temp_V_address0 { O 4 vector } temp_V_ce0 { O 1 bit } temp_V_we0 { O 1 bit } temp_V_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename H \
    op interface \
    ports { H_address0 { O 3 vector } H_ce0 { O 1 bit } H_q0 { I 17 vector } H_address1 { O 3 vector } H_ce1 { O 1 bit } H_q1 { I 17 vector } } \
} "
} else {
