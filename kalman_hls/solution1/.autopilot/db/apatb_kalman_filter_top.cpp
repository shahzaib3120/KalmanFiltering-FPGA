...
// wrapc file define:
#define AUTOTB_TVIN_z "../tv/cdatafile/c.kalman_filter_top.autotvin_z.dat"
#define AUTOTB_TVOUT_z "../tv/cdatafile/c.kalman_filter_top.autotvout_z.dat"
#define AUTOTB_TVIN_x "../tv/cdatafile/c.kalman_filter_top.autotvin_x.dat"
#define AUTOTB_TVOUT_x "../tv/cdatafile/c.kalman_filter_top.autotvout_x.dat"
#define AUTOTB_TVIN_P "../tv/cdatafile/c.kalman_filter_top.autotvin_P.dat"
#define AUTOTB_TVOUT_P "../tv/cdatafile/c.kalman_filter_top.autotvout_P.dat"
#define AUTOTB_TVIN_hostmem "../tv/cdatafile/c.kalman_filter_top.autotvin_hostmem.dat"
#define AUTOTB_TVOUT_hostmem "../tv/cdatafile/c.kalman_filter_top.autotvout_hostmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_hostmem "../tv/rtldatafile/rtl.kalman_filter_top.autotvout_hostmem.dat"
...
extern "C"
void kalman_filter_top_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_kalman_filter_top_hw(void* __xlx_apatb_param_z, void* __xlx_apatb_param_x, void* __xlx_apatb_param_P)
{
  ...
  hls::sim::Byte<4> __xlx_offset_byte_param_P;
  ...
  port1.param = &__xlx_offset_byte_param_P;
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_hostmem),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_hostmem),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_hostmem),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_hostmem),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_hostmem),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_hostmem),
#endif
#endif
  };
  __xlx_offset_byte_param_x = 0*4;
  __xlx_offset_byte_param_P = 4*4;
  port2.param = { __xlx_apatb_param_x, __xlx_apatb_param_P };
  port2.depth = { 4, 16 };
  port2.offset = { 0, 4 };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port3 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_z),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_z),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_z };
  port3.depth = { 2 };
  port3.offset = {  };
  ...
  try {
    ...
    kalman_filter_top_hw_stub_wrapper(__xlx_apatb_param_z, __xlx_apatb_param_x, __xlx_apatb_param_P);
